               ...
               <template v-slot:item="row">
                <tr>
                  ...
                  <td>            
                      ...
                      <v-btn small color="transparent" @click="bitacora(row.item.expediente)"><i class="fa fa-database" style="color:green"></i></v-btn>                                                                                
                      <div v-if="row.item.status == 'PREVIO_TRAMITE'">
                        <v-btn small color="transparent" @click="actualizarData(row.item.id)"><i class="fa fa-edit" style="color:blue"></i></v-btn>                                        
                        <v-btn small color="transparent" @click="actualizarRequisitos(row.item.id)"><i class="fa fa-file" style="color:black"></i></v-btn>                                        
                      </div>

                      <!--div v-if="row.item.status == 'NOTIFICACION'">
                        <v-btn small color="transparent" @click="aceptarNotificacion(row.item.expediente)"><i class="fa fa-check" style="color:red"></i></v-btn>                                        
                      </div-->

                      <div v-if="row.item.status == 'NOTIFICACION'">
                        <v-btn small color="transparent" @click="cargarpago(row.item.expediente)"><i class="fa fa-address-card" style="color:#ADFF2F"></i></v-btn>                                        
                      </div>
                  ...
                  <td>
                      ...
                      <v-btn small color="transparent" @click="versolicitud(row.item.expediente)"><i class="fa fa-file-pdf" style="color:blue"></i></v-btn>                                        
                  </td> 
                  <td>
