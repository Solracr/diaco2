          ...
          <v-card-title>              
            ...
            <v-data-table :headers="headers" :items="items" :search="search">
               <template v-slot:item="row">
                <tr>
                  <td>{{row.item.nombre_empresa}}</td>
                  <td>{{row.item.resolucion}}</td>
                  <td>{{row.item.correoelectronico}}</td>                                    
                  <td>{{row.item.serie}}</td>                                    
                  <td>{{row.item.marca}}</td>                                    
                  <td>{{row.item.tipobalanza}}</td>                                    
                  <td>{{row.item.status}}</td>               
                  <td>            
                    <v-btn  small color="success"><i class="fa fa-check" style="color:black"></i></v-btn>                                        
                  </td>
                  <td>
                      <v-btn small color="transparent" @click="archivos(row.item.resolucion)"><i class="fa fa-file-pdf" style="color:blue"></i></v-btn>                                                                                  
                  </td>                      
                </tr>
            </template>
            </v-data-table>
    ...
    data () {
      return {
        ...
        headers: [          
          ...
          { text: 'Expediente', value: 'resolucion' },
          { text: 'Correo', value: 'correoelectronico' },          
          { text: 'Serie', value: 'serie' }, 
          { text: 'Marca', value: 'marca' },
          { text: 'Tipo', value: 'tipobalanza' }, 
    ...
    created: function() {
     ...
     methods: {  
       ...
       archivos: function(expediente) {                              
            window.location.href = "/analista/visor/pesas?expediente="+expediente;  
        },         
        ...
        fetchAllData: function() {                    
          ...
          axios.post('/pesa/listar/expedientes', {action:this.indicador})
          .then((response) =>{                                    
